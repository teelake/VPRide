...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= vp_url('/admin/assets/brand/favicon.png') ?>" sizes="32x32">
  <link rel="apple-touch-icon" href="<?= vp_url('/admin/assets/brand/app_icon_squircle.png') ?>" sizes="180x180">
